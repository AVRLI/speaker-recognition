...
static inline float MelScale(float mel_freq, MelFormulaTypedef type);
static inline float InverseMelScale(float mel_freq, MelFormulaTypedef type);
...
__STATIC_INLINE float MelScale(float freq, MelFormulaTypedef type)
//static inline float MelScale(float freq, MelFormulaTypedef type)
{
  if (type != MEL_HTK) {
...
__STATIC_INLINE float InverseMelScale(float mel_freq, MelFormulaTypedef type)
//static inline float InverseMelScale(float mel_freq, MelFormulaTypedef type)
{
  if (type != MEL_HTK) {
    /* Malcolm Slaney's Formula */
